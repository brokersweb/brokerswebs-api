...
return new class extends Migration
{
    ...
    {
        Schema::create('independents_type', function (Blueprint $table) {
            ...
            $table->longText('chamber_commerce')->comment('Cámara de comercio');
    ...
    {
        Schema::dropIfExists('independents_type');
    }
};
